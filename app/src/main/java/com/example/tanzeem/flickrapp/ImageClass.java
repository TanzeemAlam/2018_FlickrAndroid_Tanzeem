...
//A memory cache offers fast access to bitmaps at the cost of taking up valuable application memory. The LruCache class is
//particularly well suited to the task of caching bitmaps.
